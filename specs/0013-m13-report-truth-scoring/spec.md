...
- **Per-check quality matrix** (deterministic signals):
  ...
  - **struct-layout** (0.5): src/lib/packages 0.5; gradle projects with module dirs carrying src/ (settings.gradle(.kts) + app/src — Android/kotlin) 0.5; otherwise 0 (2026-08-07, human-fixable)
