...
node <skill-dir>/scripts/transform.ts --root /path/to/repo [--stage 2|3|4|all] [--dry-run] [--ci github|gitlab|none] [--gates warn-only|hard] [--verify-timeout <minutes>] [--verify-command <cmd>] [--format json|markdown]
